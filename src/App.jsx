...
function GuidePage({ onBook }) {
  ...
  return <div className="min-h-screen bg-[#fffdfb]"><Header onBook={onBook} /><main>
    ...
    <motion.section {...A.fadeUp(0.35)} className="px-4 sm:px-6 lg:px-8 py-10"><div className="mx-auto max-w-[1040px] rounded-[24px] border border-[#e7d9ce] bg-[#fbf4ee] p-5 text-center sm:rounded-[32px] sm:p-12"><p className="section-kicker">START YOUR BRIDAL PLAN</p><h2 className="brand-serif mt-2 text-[24px] text-[#211815] sm:mt-3 sm:text-[42px] lg:text-[52px]">Ready to discuss your look, date and venue?</h2><p className="mx-auto mt-3 max-w-[680px] text-[13px] leading-6 text-[#665a54] sm:mt-4 sm:text-[14px] sm:leading-7">Use the booking page to send all the key details in one message. Final services, availability and pricing can then be confirmed directly with RS Bridal.</p><div className="mt-5 flex flex-wrap justify-center gap-2.5 sm:mt-7 sm:gap-3"><button onClick={() => onBook()} className="btn-primary !px-4 !py-2.5 !text-[12px] sm:!px-5 sm:!py-3 sm:!text-[14px]"><Icon name="calendar" size={16} /> Book Your Consultation</button><button onClick={() => navigateTo("home")} className="btn-secondary !px-4 !py-2.5 !text-[12px] sm:!px-5 sm:!py-3 sm:!text-[14px]">Back to Website</button></div></div></motion.section>
